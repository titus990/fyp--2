...
class _AdminDashboardState extends State<AdminDashboard> {
      ...
      body: Row(
        children: [
          NavigationRail(
            ...
            selectedLabelTextStyle: const TextStyle(color: Color(0xFFFF6B6B), fontWeight: FontWeight.bold),
          ...
          Expanded(
            child: _selectedIndex == 0 ? _buildOverview() : const UserManagementPage(),
          ),
        ],
      ),
    );
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.hasData) {
          ...
          admins = snapshot.data!.docs.where((doc) => (doc.data() as Map<String, dynamic>)['role'] == 'admin').length;
        }
            ...
            children: [
              ...
              Wrap(
                ...
                children: [
                  ...
                  _buildStatCard('Admins', admins.toString(), Icons.admin_panel_settings),
                  _buildStatCard('System Status', 'Active', Icons.check_circle, color: Colors.greenAccent),
                ],
              ),
            ],
          ),
  ...
  Widget _buildStatCard(String title, String value, IconData icon, {Color color = const Color(0xFFFF6B6B)}) {
    return Container(
      width: 200,
